...
if DEBUG:
    ...
    ALLOWED_HOSTS = ["setes.net", "www.setes.net"]
...
# STORAGES (Django 6.x) - Cloudinary pour les media, WhiteNoise pour les static en prod
STORAGES = {
    "default": {
...
EMAIL_PORT = 465
EMAIL_USE_SSL = True
EMAIL_HOST_USER = "contact@setes.net"
